    ...
    return (
      <IonApp>
        ...
        <IonAlert
          cssClass='uiFont'
          backdropDismiss={false}
          isOpen={!this.props.settings.langInitialized || this.props.tmpSettings.showLangSelector}
        ...
        <IonAlert
          cssClass='uiFont'
          backdropDismiss={false}
          isOpen={this.props.settings.langInitialized && !this.props.settings.appInitialized}
          header={this.props.t('FirstStart')}
          message={this.props.t('FirstStartMsg')}
          buttons={[
            {
              text: this.props.t('Ok'),
              cssClass: 'primary uiFont',
