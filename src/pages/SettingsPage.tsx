        ...
        <IonContent>
          <IonList>
            ...
            <IonItem>
              ...
              }}>PWA版本: <a href="https://github.com/MrMYHuang/cbt-dict#history" target="_new">{PackageInfos.pwaVersion}</a></IonLabel>
              <IonButton fill='outline' shape='round' slot='end' size='large' className='uiFont' onClick={e => {
            ...
            <IonItem>
              ...
              <div style={{ width: '100%' }}>
                <IonLabel className='ion-text-wrap uiFont'>{this.props.t('UpdateOfflineData')}</IonLabel>
                <IonLabel className='ion-text-wrap uiFont'>{this.props.t('LastUpdate')}: {new Date(this.props.settings.assetsUpdateDate).toLocaleDateString()}</IonLabel>
              </div>
              <IonButton fill='outline' shape='round' slot='end' size='large' className='uiFont' onClick={async (e) => this.updateOfflineData()}>{this.props.t('Update')}</IonButton>
            </IonItem>
            <IonItem>
              <div tabIndex={0}></div>{/* Workaround for macOS Safari 14 bug. */}
              <IonIcon icon={bug} slot='start' />
              <IonLabel className='ion-text-wrap uiFont'><a href="https://github.com/MrMYHuang/cbt-dict#report" target="_new">{this.props.t('enableErrorLog')}</a></IonLabel>
            ...
            <IonItem>
              ...
              <IonSelect slot='end'
                ...
                className='uiFont'
                interface='popover'
                interfaceOptions={{ cssClass: 'cbt-dictthemes' }}
                onIonChange={e => {
            ...
            <IonItem>
              ...
              <div className='uiFont'>
                ...
                <div><a href="https://github.com/MrMYHuang/cbt-dict" target="_new">{this.props.t('manualAndOpenSource')}</a></div>
                <div><a href="https://github.com/MrMYHuang/cbt-dict#copyrights" target="_new">{this.props.t('copyrights')}</a></div>
              </div>
            </IonItem>
          </IonList>
